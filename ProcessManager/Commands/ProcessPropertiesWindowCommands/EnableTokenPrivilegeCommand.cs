...
{
    public class EnableTokenPrivilegeCommand : ICommand
    {
        private readonly ProcessPropertiesVM VM;

        public EnableTokenPrivilegeCommand(ProcessPropertiesVM VM)
        {
            this.VM = VM;
        }
        ...
        public void Execute(object Parameter)
        {
            ...
            if (!VM.EnablePrivilege(Parameters.Item1.PrivilegesInfo[Parameters.Item2].Name))
            {
