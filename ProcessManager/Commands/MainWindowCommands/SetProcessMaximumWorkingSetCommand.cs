...
{
    public class SetProcessMaximumWorkingSetCommand : ICommand
    {
        private readonly ProcessInfoVM VM;

        public SetProcessMaximumWorkingSetCommand(ProcessInfoVM VM)
        {
            this.VM = VM;
        }
        ...
        public void Execute(object Parameter)
        {
            ...
            WorkingSetSizeWindow Window = new(MaximumSize, MinimumSize, false, Info);
