    ...
    public static class NativeMethods
    {
        ...
        public static class Win32Enumerations
        {
            ...
            public enum MemoryProtections : uint
            {
                ...
                PAGE_WRITECOPY = 0x08,
                /// <summary>
                /// Imposta tutte le posizione nelle pagine con non valide per CFG.<br/>
...
#pragma warning restore CA1069 // I valori di enumerazione non devono essere duplicati
            ...
            public enum ShutdownFlags : uint
            {
                ...
                /// </summary>
                /// <remarks>Se la disonnessione avviene in modo interrattivo, lo spegnimento non è garantito.</remarks>
        ...
        public static class Win32Structures
        {
            ...
            /// <summary>
            /// Informazioni sul nome di un oggetto.
            /// </summary>
            [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
            public struct OBJECT_NAME_INFORMATION
            {
                ...
                /// <summary>
                /// Buffer con il nome UNICODE dell'oggetto.
                /// </summary>
...
#pragma warning restore CA1720 // L'identificatore contiene il nome di tipo
        ...
        public static class Win32OtherFunctions
        {
            ...
            /// </summary>
            /// <param name="Destination">Puntatore all'indirizzo dove copiare i dati.</param>
            /// <param name="Source">Puntatore all'indirizzo del blocco di memoria da copiare.</param>
            /// <param name="Size">Dimensione, in bytes, della memoria da copiare.</param>
            [DllImport("Kernel32.dll", EntryPoint = "CopyMemory", SetLastError = true)]
            public static extern void CopyMemory(IntPtr Destination, IntPtr Source, IntPtr Size);
            ...
            /// <summary>
            /// Recupera una lista di stringhe che specificano unità valide nel sistema.
            /// </summary>
            /// <param name="BufferLength">Dimensione di <paramref name="Buffer"/>.</param>
            /// <param name="Buffer">Buffer che riceve la lista.</param>
            /// <returns>Lunghezza, in caratteri, delle stringhe copiate nel buffer.</returns>
            [DllImport("Kernel32.dll", EntryPoint = "GetLogicalDriveStringsW", SetLastError = true, CharSet = CharSet.Unicode)]
            public static extern uint GetLogicalDriveStrings(uint BufferLength, char[] Buffer);

            /// <summary>
            /// Recupera informazioni su nomi DOS delle unità disco.
            /// </summary>
            /// <param name="DeviceName">Nome dell'unità.</param>
            /// <param name="TargetPath">Buffer che riceve i risultati della query.</param>
            /// <param name="MaxChars">Numero massimo di caratteri che <paramref name="TargetPath"/> può ospitare.</param>
            /// <returns>Numero di caratteri scritti in <paramref name="TargetPath"/>, 0 in caso di errore.</returns>
            /// <remarks>Se <paramref name="DeviceName"/> è nullo, questa funzione recupera informazioni su tutti i dispositivi MS-DOS presenti, altrimenti recupera informazioni sul dispositivo specificato.<br/>
            /// Quando la funzione recupera informazioni su un dispositivo specifico, la prima stringa in <paramref name="TargetPath"/> rappresenta l'attuale mapping del dispositivo, eventuali altre stringhe rappresentano i mapping precedenti non ancora eliminati.</remarks>
            [DllImport("Kernel32.dll", EntryPoint = "QueryDosDeviceW", SetLastError = true, CharSet = CharSet.Unicode)]
            public static extern uint QueryDosDevice(string DeviceName, char[] TargetPath, uint MaxChars);
            ...
            /// <param name="ReturnLength">Dimensione richiesta del parametro <paramref name="InformationStructure"/> per completare l'operazione.</param>
            /// <returns>Un valore che indica il risultato dell'operazione.</returns>
            [DllImport("Ntdll.dll", EntryPoint = "NtQueryObject", SetLastError = true)]
            ...
            /// <returns>Un valore che indica il risultato dell'operazione.</returns>
            [DllImport("Ntdll.dll", EntryPoint = "NtDuplicateObject", SetLastError = true)]
            ...
            /// <summary>
            /// Resta in attesa fino a quando uno o tutti gli oggetti non sono in stato segnalato, un APC è stata messa in coda al thread oppure il tempo specificato è passato.
            /// </summary>
            ...
            /// <param name="Alertable">Indica se la funzione deve restituire quando un APC viene messa in coda al thread.</param>
            ...
            /// Se la funzione restituisce <see cref="Win32Enumerations.WaitResult.WAIT_IO_COMPLETION"/>, un APC è stato messo in coda al thread.<br/><br/>
            ...
            [DllImport("Kernel32.dll", EntryPoint = "WaitForMultipleObjectsEx", SetLastError = true)]
            public static extern uint WaitForMultipleObjects(uint HandleCount, IntPtr Handles, [MarshalAs(UnmanagedType.Bool)] bool WaitAll, uint Milliseconds, [MarshalAs(UnmanagedType.Bool)] bool Alertable);
        ...
        public static class Win32FileFunctions
        {
            ...
            #endregion
            /// <summary>
            /// Calcola il checksum del file immagine.
            /// </summary>
        ...
        public static class Win32MemoryFunctions
        {
            ...
            [return: MarshalAs(UnmanagedType.Bool)]
            public static extern bool VirtualProtectEx(IntPtr ProcessHandle, IntPtr BaseAddress, IntPtr Size, Win32Enumerations.MemoryProtections NewProtect, out Win32Enumerations.MemoryProtections OldProtect);
            ...
            [return: MarshalAs(UnmanagedType.Bool)]
            public static extern bool VirtualFreeEx(IntPtr ProcessHandle, IntPtr BaseAddress, IntPtr Size, Win32Enumerations.FreeOperationType FreeType);
            ...
            public static extern IntPtr VirtualQueryEx32(IntPtr ProcessHandle, IntPtr Address, out Win32Structures.MEMORY_BASIC_INFORMATION Buffer, ulong Length);
            ...
            /// <remarks>Se il parametro <paramref name="Address"/> punta a un indirizzo di memoria oltre il limite massimo di indirizzi di memoria accessibili al processo la funzione restituisce il codice di errore <see cref="Win32Constants.ERROR_INVALID_PARAMETER"/>.</remarks>
            [DllImport("Kernel32.dll", EntryPoint = "VirtualQueryEx", SetLastError = true)]
            public static extern IntPtr VirtualQueryEx64(IntPtr ProcessHandle, IntPtr Address, out Win32Structures.MEMORY_BASIC_INFORMATION64 Buffer, ulong Length);
            #endregion
            /// <summary>
        ...
        public static class Win32ShutdownFunctions
        {
            ...
            /// <see cref="Win32Constants.ERROR_SHUTDOWN_IS_SCHEDULED"/> (Lo spegnimento è stato è stato programmato ma non è iniziato)<br/>
        ...
        public static class Win32ComputerInfoFunctions
        {
            ...
            /// <returns>true se l'operazione è riuscita, false altrimenti.</returns>
            [return: MarshalAs(UnmanagedType.Bool)]
            [DllImport("Kernel32.dll", EntryPoint = "GetProductInfo")]
